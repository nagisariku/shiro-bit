...
import { Code, CreditCard, FileCheck, ShieldCheck } from 'lucide-react'
import { BlurFade } from '@/components/magicui/blur-fade'

const FixedTimeline = () => {
  const items = [
    {
      title: 'Requirements & Payment',
      desc: 'Submit your website requirements and complete the payment to get started.',
      icon: <CreditCard size={32} />,
    },
    {
      title: 'Development',
      desc: 'We design and develop your website and send you progress reports daily.',
      icon: <Code size={32} />,
    },
    {
      title: 'Go Live!',
      desc: 'Your website goes live! You’ll receive full post-production support.',
